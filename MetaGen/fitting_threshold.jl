...
dict = @pipe "/Users/marleneberke/Documents/03_Yale/Projects/001_Mask_RCNN/scratch_work_07_16_21/09_30/dataset_many_obj_models/retinanet/data_labelled_retinanet.json" |> open |> read |> String |> JSON.parse
...
function fit_threshold_NN(office_subset::Vector{String}, num_videos::Int64, num_frames::Int64, dict::Any,
...
office_subset_rep = fill(office_subset, length(thresholds))
...
how_good = map(fit_threshold_NN, office_subset_rep, vs, fs, dicts, gts, thresholds)
